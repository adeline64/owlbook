...
abstract class FactoryRole {

	public static function getFromTableRole($id=0) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table role');
		}
		...
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Role($data['id'],$data['nom'],$data['description']);
		}
