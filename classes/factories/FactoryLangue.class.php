...
abstract class FactoryLangue {

	public static function getFromTableLangue($id=0) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table langue');
		}
		...
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Langue($data['id'],$data['locale'],$data['originale']);
		}
