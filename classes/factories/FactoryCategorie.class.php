...
abstract class FactoryCategorie {

	public static function getFromTableCategorie($id=0) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table categorie');
		}
		...
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Categorie($data['id'],$data['nom']);
		}
