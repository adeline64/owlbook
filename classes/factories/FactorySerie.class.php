...
abstract class FactorySerie {

	public static function getFromTableSerie($id=0) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table serie');
		}
		...
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Serie($data['id'],$data['num'],$data['nom']);
		}
