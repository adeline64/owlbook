...
abstract class FactoryGenre {

	public static function getFromTableGenre($id=0) {
		...
		if (! database::getInstance() -> executeRequete()) {
			throw new Exception(__CLASS__.'::'.__FUNCTION__.'(): Impossible de lire la table genre');
		}
		...
		foreach ($datas AS $data) {
			/* objet par defaut */
			$listeObjet[] = new Genre($data['id'],$data['nom']);
		}
