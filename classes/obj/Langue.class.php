...
class Langue {
	protected $id; /* int(11) */
	protected $locale; /* varchar(50) */
	protected $originale; /* varchar(50) */
	protected $empty = true; // permet de savoir si l'objet est vide

	public function __construct($id=0,$locale='',$originale='') {
	...
	public function setLocale($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet() on 10/05/2019 12:52:19
		$this->locale = $nouvelleValeur;
	}



	public function setOriginale($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet() on 10/05/2019 12:52:19
		$this->originale = $nouvelleValeur;
	}
	...
	public function __toString() {
		...
		$chaine .= 'Le champ locale vaut '.$this->getLocale().'<br/>';
		$chaine .= 'Le champ originale vaut '.$this->getOriginale().'<br/>';
		return $chaine;
	}
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO langue (id,locale,originale)';
			$requete .= ' VALUES ';
			$requete .= '(';
				$requete .= 'locale,';
				$requete .= 'originale,';
	...
	public function update() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			$requete .= 'locale = \''.$this->getLocale().'\',';
			$requete .= 'originale = \''.$this->getOriginale().'\',';
			$requete = substr($requete,0,strlen($requete)-1);
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM langue WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent() on 10/05/2019 12:52:19
		return ('parent::__construct($id,$locale,$originale);');
	}
	...
	public function compareTo($object) {
		...
		if ($object instanceof Langue) {
			...
			if ($this->locale != $object->getLocale()) {
				$data['locale'] = $object->getLocale();
			}
			if ($this->originale != $object->getOriginale()) {
				$data['originale'] = $object->getOriginale();
			}
		}
		return $data;
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Langue.tpl');
	}
