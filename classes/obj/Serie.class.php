...
class Serie {
	...
	public function setNum($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet() on 10/05/2019 12:52:19
		$this->num = $nouvelleValeur;
	}
	...
	public function __toString() {
		...
		$chaine .= 'Le champ num vaut '.$this->getNum().'<br/>';
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO serie (id,num,nom)';
			$requete .= ' VALUES ';
			$requete .= '(';
				$requete .= 'num,';
				$requete .= 'nom,';
	...
	public function update() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			$requete = 'UPDATE serie SET ';
			$requete .= 'num = \''.$this->getNum().'\',';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM serie WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent() on 10/05/2019 12:52:19
		return ('parent::__construct($id,$num,$nom);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Serie.tpl');
	}
