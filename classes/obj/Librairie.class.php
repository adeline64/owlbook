...
class Librairie {
	...
	protected $codepostal; /* varchar(50) */
	protected $pays; /* varchar(50) */
	protected $empty = true; // permet de savoir si l'objet est vide

	public function __construct($id=0,$nom='',$ville='',$codepostal='',$pays='') {
	...
	public function setPays($nouvelleValeur) {
		//Generated by ObjectGenerator::generateSet() on 10/05/2019 12:52:19
		$this->pays = $nouvelleValeur;
	}
	...
	public function __toString() {
		...
		$chaine .= 'Le champ pays vaut '.$this->getPays().'<br/>';
		return $chaine;
	}
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO librairie (id,nom,ville,codepostal,pays)';
			$requete .= ' VALUES ';
			$requete .= '(';
				$requete .= 'nom,';
				$requete .= 'ville,';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM librairie WHERE id = '.$this->getId();
		}
	}

	public function getParent() {
		//Generated by ObjectGenerator::generateGetParent() on 10/05/2019 12:52:19
		return ('parent::__construct($id,$nom,$ville,$codepostal,$pays);');
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Librairie.tpl');
	}
