...
class Role {
	...
	public function save() {
		...
		if ($this->getId() > 0) {
			...
			$requete = 'INSERT INTO role (id,nom,description)';
			$requete .= ' VALUES ';
			$requete .= '(';
				$requete .= 'nom,';
				$requete .= 'description,';
	...
	public function delete() {
		...
		if ($this->getId() == 0 || $this->getId() == null) {
			...
			return 'DELETE FROM role WHERE id = '.$this->getId();
		}
	}
	...
	public function affiche() {
		...
		$smarty->display(_TEMPLATES_BASE_.'classes/Role.tpl');
	}
