...
class ManagerUtilisateur extends Manager{
	...
	public function add( $data) {
		...
		$req = $this->db->prepare('INSERT INTO utilisateur (nom,prenom,adresse,codepostal,ville,email,password,role) VALUES(:nom,:prenom,:adresse,:codepostal,:ville,:email,:password,:role)');
